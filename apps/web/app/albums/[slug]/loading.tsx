    ...
    <main className="py-10" aria-busy="true" aria-label="Loading album">
      <Container>
        ...
        <div className="flex flex-col items-center gap-6 py-8 sm:flex-row sm:items-start">
          ...
          <div
            aria-hidden="true"
            className="h-48 w-48 shrink-0 animate-pulse rounded-[16px] bg-[var(--surface)] sm:h-56 sm:w-56"
          />

          {/* Metadata */}
          <div className="flex flex-col items-center gap-2 sm:items-start">
            <div aria-hidden="true" className="h-9 w-64 animate-pulse rounded-[8px] bg-[var(--surface)]" />
            <div aria-hidden="true" className="h-5 w-36 animate-pulse rounded-[8px] bg-[var(--surface)]" />
        ...
        {/* Track list skeleton */}
        <div className="mt-8">
          <div aria-hidden="true" className="mb-4 h-7 w-20 animate-pulse rounded-[8px] bg-[var(--surface)]" />
          <ol
            role="list"
