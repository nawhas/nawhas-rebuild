    ...
    <main className="py-10" aria-busy="true" aria-label="Loading track">
      <Container size="md">
        ...
        <div className="py-8 flex flex-col gap-3">
          <div aria-hidden="true" className="h-9 w-72 animate-pulse rounded bg-gray-200" />
          <div aria-hidden="true" className="h-4 w-48 animate-pulse rounded bg-gray-200" />
        </div>

        {/* Audio player reserved space skeleton */}
        <div aria-hidden="true" className="mt-2 h-14 animate-pulse rounded-lg bg-gray-100" />

        {/* Lyrics skeleton */}
        <div className="mt-10">
          <div aria-hidden="true" className="mb-6 h-7 w-16 animate-pulse rounded bg-gray-200" />
