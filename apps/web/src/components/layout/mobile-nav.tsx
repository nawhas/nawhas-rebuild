  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="rounded p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
      >
        <svg
            ...
            {user ? (
              <div className="space-y-1">
                ...
                <Link
                  href="/profile"
                  onClick={close}
                  className="block rounded px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                >
                  Profile
                </Link>
                <button
                  ...
                  className="block w-full rounded px-3 py-2 text-left text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                >
                  Sign Out
                </button>
              </div>
